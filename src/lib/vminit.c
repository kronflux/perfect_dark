...
void vm_init(void)
{
...
#endif
	{
		...
		dma_exec(g_VmZipTable, (romptr_t) REF_SEG _gamezipSegmentRomStart, ALIGN16((numentries + 1) << 2));
		...
		// Load gamezips pointer list
		dma_exec(romaddrs, (romptr_t) REF_SEG _gamezipSegmentRomStart, ALIGN16((numentries2 + 1) << 2));
