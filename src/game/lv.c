...
Gfx *lvRenderFPS(Gfx *gdl)
{
	...
	if (g_CharsNumeric && g_FontNumeric) {
		...
		gdl = text0f153628(gdl);
		gdl = text_render(gdl, &x, &y, buffer, g_CharsNumeric, g_FontNumeric, color, 0x000000a0, vi_get_width(), vi_get_height(), 0, 0);
		gdl = text0f153780(gdl);
...
void lv_tick(void)
{
	...
	if ((joy_get_buttons_pressed_this_frame(0, 0xffffffff) != 0
				|| joy_get_stick_x(0) > 10
				|| joy_get_stick_x(0) < -10
				|| joy_get_stick_y(0) > 10
				|| joy_get_stick_y(0) < -10
				|| joy_get_buttons_pressed_this_frame(1, 0xffffffff) != 0
				|| joy_get_stick_x(1) > 10
				|| joy_get_stick_x(1) < -10
				|| joy_get_stick_y(1) > 10
				|| joy_get_stick_y(1) < -10
				|| joy_get_buttons_pressed_this_frame(2, 0xffffffff) != 0
				|| joy_get_stick_x(2) > 10
				|| joy_get_stick_x(2) < -10
				|| joy_get_stick_y(2) > 10
				|| joy_get_stick_y(2) < -10
				|| joy_get_buttons_pressed_this_frame(3, 0xffffffff) != 0
	...
	if (g_Vars.stagenum < STAGE_TITLE && !g_IsTitleDemo && !g_Vars.in_cutscene) {
		if (joy_get_buttons(0, 0xffffffff) == 0
				&& joy_get_stick_x(0) < 10
				&& joy_get_stick_x(0) > -10
				&& joy_get_stick_y(0) < 10
				&& joy_get_stick_y(0) > -10
				&& joy_get_buttons(1, 0xffffffff) == 0
				&& joy_get_stick_x(1) < 10
				&& joy_get_stick_x(1) > -10
				&& joy_get_stick_y(1) < 10
				&& joy_get_stick_y(1) > -10
				&& joy_get_buttons(2, 0xffffffff) == 0
				&& joy_get_stick_x(2) < 10
				&& joy_get_stick_x(2) > -10
				&& joy_get_stick_y(2) < 10
				&& joy_get_stick_y(2) > -10
				&& joy_get_buttons(3, 0xffffffff) == 0
				&& joy_get_stick_x(3) < 10
				&& joy_get_stick_x(3) > -10
				&& joy_get_stick_y(3) < 10
				&& joy_get_stick_y(3) > -10) {
...
void lv_stop(void)
{
	...
	if (g_MiscAudioHandle && sndp_get_state(g_MiscAudioHandle)) {
		sndp_stop_sound(g_MiscAudioHandle);
	}
