 ...
 */
void botinv_score_weapon(struct chrdata *chr, s32 weaponnum, s32 funcnum, s32 arg3, bool arg4, s32 *dst1, s32 *dst2, bool comparewithtarget, bool arg8)
{
	s32 score1 = 0;
	s32 score2 = 0;
	s32 extra = 0;
...
void botinv_score_weapon_against_target(struct chrdata *chr, s32 weaponnum, s32 funcnum, s32 arg3, bool arg4, s32 *dst1, s32 *dst2)
{
	botinv_score_weapon(chr, weaponnum, funcnum, arg3, arg4, dst1, dst2, true, true);
}

void botinv_score_weapon_by_itself(struct chrdata *chr, s32 weaponnum, s32 funcnum, s32 arg3, bool arg4, s32 *dst1, s32 *dst2)
{
	botinv_score_weapon(chr, weaponnum, funcnum, arg3, arg4, dst1, dst2, false, true);
}
