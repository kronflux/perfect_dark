...
const char var7f1b20b8nb[] = "music_start_watch start\n";
...
const char var7f1b2138nb[] = "music_start_cutscene\n";
const char var7f1b214cnb[] = "music_end_cutscene\n";
const char var7f1b2160nb[] = "music_start_ambient : Tune=%d\n";
