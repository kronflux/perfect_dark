...
ALEnvelope *snd_load_envelope(uintptr_t offset, u16 index);
ALKeyMap *snd_load_keymap(uintptr_t offset, u16 index);
ALADPCMBook* snd_load_adpcm_book(uintptr_t offset, u16 index);
ALADPCMloop* snd_load_adpcm_loop(uintptr_t offset, u16 index);
ALWaveTable* snd_load_wavetable(uintptr_t offset, u16 index);
