...
bool chr_can_move_directly_to_pos(struct chrdata *chr, struct coord *arg1, RoomNum *arg2, struct coord *arg3, struct coord *arg4, s32 cdtypes);
...
bool chr_prop_can_move_to_pos_without_nav_slow(struct prop *prop, struct coord *coord);
...
bool chr_calculate_aimend(struct chrdata *chr, struct attackanimconfig *animcfg, s32 arg2, s32 arg3, f32 arg4);
